...
namespace ORUSCURSO.Presentacion
{
    public partial class CtlUsuarios : UserControl
    {
        ...
        private void insertarUsuarios()
        {
            ...
            {
                parametros.Id_personal = Convert.ToInt32(txtIdPersonal.Text);
            }
            else
            {
                // MessageBox.Show("Mensaje" + Convert.ToInt32(txtIdAdmin.Text), "Mensaje", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                parametros.Id_personal = Convert.ToInt32(txtIdGerente.Text);
            }
        ...
        private void validarPermisos()
        {
            ...
            foreach (DataRow rowPermisos in dt.Rows)
            {
                ...
                if (Modulo == "Usuarios")
                {
                    datalistadoUsuarios.Columns[0].Visible = false;
        ...
        public void ObtenerIdUsuario2(int idPara)
        {
        ...
        private void ObtenerDatos()
        {
            ...
            txtIdPersonal.Text = datalistadoUsuarios.SelectedCells[8].Value.ToString();
            // MessageBox.Show("Dato" + datalistadoUsuarios.SelectedCells[8].Value.ToString(), "Eliminando registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
